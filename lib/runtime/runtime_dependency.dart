...
class RuntimeDependency {
  ...
  static List<RuntimeDependency> get all => [
        ...
        const RuntimeDependency(
          ...
          displayName: 'uv / uvx',
          icon: '🚀',
          dependencies: [RuntimeTool.python],
          hint: 'Python 包管理器，Qwen-MM-Plugins MCP server 按需启动',
        ),
        const RuntimeDependency(
        ...
        const RuntimeDependency(
          ...
          displayName: 'Qwen-MM-Plugins',
          icon: '🖼️',
          dependencies: [RuntimeTool.uv, RuntimeTool.codexCli],
          hint: 'Qwen 多模态能力（读图/视频/文档/3D + 云端 VL/OCR/ASR），8 个 Skill + MCP server',
        ),
        const RuntimeDependency(
