...
class HomePage extends ConsumerWidget {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 8),
                  const _StatusRow(label: 'Linux Runtime', value: '✅ 已集成', color: Colors.green),
                  const SizedBox(height: 8),
            ...
            child: Column(
              children: [
                ListTile(
                  ...
                  subtitle: Text('${wsState.workspaces.length} ${s.workspaceProjects}'),
                ...
                ListTile(
                  ...
                  title: const Text('关于'),
                  subtitle: const Text('版本 · 仓库 · 开源许可'),
                  trailing: const Icon(Icons.chevron_right),
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const _InfoRow(label: 'Linux Runtime', value: 'PRoot + Ubuntu'),
        ...
        onDestinationSelected: (index) {
          switch (index) {
            case 0:
              break;
            case 1:
              context.push(RouteNames.terminal);
              break;
            case 2:
              context.push(RouteNames.repoList);
              break;
            case 3:
  ...
  void _openWorkspaceList(BuildContext context, WidgetRef ref) {
    Navigator.of(context).push(MaterialPageRoute(builder: (_) => const WorkspaceListPage()));
  }
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.workspace_premium, color: colorScheme.primary, size: 24),
                const SizedBox(width: 8),
                Text(s.workspaceInfo, style: theme.textTheme.titleSmall?.copyWith(fontWeight: FontWeight.bold)),
                const Spacer(),
                TextButton.icon(
                  onPressed: onManage,
            ...
            if (currentWs != null)
              Container(
                ...
                child: Row(
                  children: [
                    Text(currentWs.template.icon, style: const TextStyle(fontSize: 32)),
                    const SizedBox(width: 12),
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text(currentWs.name, style: theme.textTheme.titleMedium?.copyWith(fontWeight: FontWeight.w600)),
                          const SizedBox(height: 2),
                          Text('${currentWs.template.name} · ${currentWs.projects.length} ${s.workspaceProjects}',
              ...
              Container(
                ...
                child: Column(
                  children: [
                    Text(s.workspaceEmpty, style: theme.textTheme.bodyMedium?.copyWith(color: colorScheme.onSurfaceVariant)),
                    const SizedBox(height: 8),
                    FilledButton.icon(
                      onPressed: onCreate,
            ...
            if (currentWs != null) ...[
              ...
              Row(
                children: [
                  _QuickChip(icon: Icons.folder_outlined, label: s.workspaceQuickNew, onTap: () {}),
                  const SizedBox(width: 8),
                  _QuickChip(icon: Icons.folder_open_outlined, label: s.workspaceQuickOpen, onTap: () {}),
                  const SizedBox(width: 8),
                  _QuickChip(icon: Icons.smart_toy_outlined, label: s.workspaceQuickAi, onTap: () {}),
                  const SizedBox(width: 8),
                  _QuickChip(icon: Icons.terminal_outlined, label: s.workspaceQuickTerminal, onTap: () {}),
                ],
              ),
            ],
          ],
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Text(subtitle, style: Theme.of(context).textTheme.bodySmall?.copyWith(fontSize: 10, color: color)),
            ],
          ),
        ),
      ),
...
class _InfoRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Row(
        children: [
          SizedBox(width: 80, child: Text(label, style: Theme.of(context).textTheme.bodySmall?.copyWith(color: variant))),
